  ...
  return (
    <section className="py-24 border-t border-white/5 bg-black/40">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-px before:bg-gradient-to-b before:from-transparent before:via-primary/50 before:to-transparent">
          {[
            ...
            >
              <div className="flex items-center justify-center w-10 h-10 border border-primary/50 bg-background font-mono text-xs font-bold text-primary z-10 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 rounded-none">
                {item.step}
              </div>
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-6 tactical-border bg-card/50 backdrop-blur-sm rounded-none">
                <h4 className="font-mono font-bold uppercase text-lg mb-2 text-foreground">{item.title}</h4>
                <p className="text-sm font-mono text-secondary-foreground leading-[1.5]">{item.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
