    ...
    <section className="py-32 border-t border-primary/20 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary/10 via-background to-background relative">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          <p className="text-xl font-mono text-secondary-foreground mb-10 max-w-xl mx-auto">
            The narrative is shaped by those on the ground. Secure your credentials. Await command.
          </p>
          <JoinModal trigger={
            <Button size="lg" className="h-16 px-12 text-lg font-mono uppercase tracking-widest font-bold bg-primary hover:bg-primary/90 text-primary-foreground rounded-sm" data-testid="btn-join-footer">
              Enter the Corps
            </Button>
          } />
        </motion.div>
