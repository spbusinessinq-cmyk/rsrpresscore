        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <motion.div 
              ...
              className={`p-6 tactical-border bg-card/50 backdrop-blur-sm relative group overflow-hidden ${tier.full || ''}`}
            >
              ...
              <p className="text-sm text-secondary-foreground font-sans">{tier.desc}</p>
