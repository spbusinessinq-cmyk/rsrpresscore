      ...
      <header className="fixed top-0 w-full z-50 border-b border-primary/20 bg-background/90 backdrop-blur-md">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-primary/10 flex items-center justify-center border border-primary/50">
          ...
          <ApplicationModal trigger={
            <Button variant="outline" size="sm" className="font-mono text-xs uppercase tracking-wider border-primary/50 hover:bg-primary/10 rounded-none h-8" data-testid="btn-join-header">
              Request Access
            </Button>
          } />
        </div>
